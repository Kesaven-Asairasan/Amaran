...
if ( ! empty( $quote_text ) ) {
	...
	<div class="qodef-e-quote">
		<span class="qodef-quote-mark"><?php echo touchup_quote_svg(); ?></span>
		<<?php echo touchup_escape_title_tag( $title_tag ); ?> class="qodef-e-quote-text"><?php echo esc_html( $quote_text ); ?></<?php echo touchup_escape_title_tag( $title_tag ); ?>>
		<?php if ( ! empty( $quote_author ) ) { ?>
			<<?php echo touchup_escape_title_tag( $author_title_tag ); ?> class="qodef-e-quote-author"><?php echo esc_html( $quote_author ); ?></<?php echo touchup_escape_title_tag( $author_title_tag ); ?>>
		<?php } ?>
		<?php if ( ! is_single() ) { ?>
