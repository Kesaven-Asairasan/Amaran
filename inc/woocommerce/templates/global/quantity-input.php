...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'touchup' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'touchup' );
	...
	<div class="qodef-quantity-buttons quantity">
		...
		<input type="text"
			<?php echo esc_attr( $readonly ) ? 'readonly="readonly"' : ''; ?>
				...
				aria-label="<?php esc_attr_e( 'Product quantity', 'touchup' ); ?>"
				size="4"
